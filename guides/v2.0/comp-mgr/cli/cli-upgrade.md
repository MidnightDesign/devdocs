...
2.	Enter the following commands in the order shown:
	...
	For example, to upgrade to Magento CE version 2.0.5, enter:

		composer require magento/product-community-edition 2.0.5 --no-update
		composer update

	To upgrade to Magento EE version 2.0.5, enter:

		composer require magento/product-enterprise-edition 2.0.5 --no-update
		composer update
